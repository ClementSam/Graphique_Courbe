...
class GraphController:
    ...
    def add_graph(self, name: str = None):
        ...
        logger.debug(f"✅ [GraphController.add_graph] Graphique '{name}' ajouté via service.")
        self.ui.refresh_plot()
    ...
    def add_curve(self, graph_name: str):
        ...
        logger.debug(f"✅ [GraphController.add_curve] Courbe '{curve.name}' ajoutée à '{graph_name}'")
        self.ui.refresh_plot()
