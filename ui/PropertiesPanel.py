...
class PropertiesPanel(QtWidgets.QTabWidget):
    ...
    def setup_graph_tab(self):
        ...
        general_group = QtWidgets.QGroupBox("Affichage général")
        gen_layout = QtWidgets.QVBoxLayout(general_group)
        gen_layout.addWidget(self.grid_checkbox)
        gen_layout.addWidget(self.darkmode_checkbox)
        gen_layout.addWidget(self.logx_checkbox)
        gen_layout.addWidget(self.logy_checkbox)
        layout.addWidget(general_group)

        axes_group = QtWidgets.QGroupBox("Axes")
        axes_layout = QtWidgets.QVBoxLayout(axes_group)
        axes_layout.addWidget(QtWidgets.QLabel("Police :"))
        axes_layout.addWidget(self.font_combo)
        ...
        axes_layout.addLayout(unit_layout)
        layout.addWidget(axes_group)

        navigation_group = QtWidgets.QGroupBox("Navigation")
        nav_layout = QtWidgets.QVBoxLayout(navigation_group)
        nav_layout.addWidget(self.auto_x_checkbox)
        nav_layout.addWidget(self.auto_y_checkbox)
        nav_layout.addWidget(self.mouse_x_checkbox)
        nav_layout.addWidget(self.mouse_y_checkbox)
        nav_layout.addWidget(self.button_reset_zoom)
        nav_layout.addWidget(self.button_reset_zoom_x)
        nav_layout.addWidget(self.button_reset_zoom_y)
        nav_layout.addWidget(self.fix_y_checkbox)
    ...
    def setup_curve_tab(self):
        ...
        appearance_group = QtWidgets.QGroupBox("Apparence")
        app_layout = QtWidgets.QVBoxLayout(appearance_group)
        app_layout.addWidget(QtWidgets.QLabel("Épaisseur :"))
        app_layout.addWidget(self.width_spin)
        app_layout.addWidget(QtWidgets.QLabel("Style :"))
        app_layout.addWidget(self.style_combo)
        app_layout.addWidget(self.color_button)
        app_layout.addWidget(QtWidgets.QLabel("Opacité (%) :"))
        app_layout.addWidget(self.opacity_slider)
        app_layout.addWidget(QtWidgets.QLabel("Symbole :"))
        app_layout.addWidget(self.symbol_combo)
        app_layout.addWidget(self.fill_checkbox)
        app_layout.addWidget(QtWidgets.QLabel("Type d'affichage :"))
        app_layout.addWidget(self.display_mode_combo)
        app_layout.addWidget(QtWidgets.QLabel("Indicateur de zéro :"))
        app_layout.addWidget(self.zero_indicator_combo)
        layout.addWidget(appearance_group)

        down_group = QtWidgets.QGroupBox("Échantillonnage")
        down_layout = QtWidgets.QVBoxLayout(down_group)
        down_layout.addWidget(QtWidgets.QLabel("Downsampling :"))
        down_layout.addWidget(self.downsampling_combo)
        ...
        down_layout.addLayout(ds_layout)
        layout.addWidget(down_group)

        transform_group = QtWidgets.QGroupBox("Transformations")
        trans_layout = QtWidgets.QVBoxLayout(transform_group)
        trans_layout.addWidget(QtWidgets.QLabel("Mode de gain :"))
        trans_layout.addWidget(self.gain_mode_combo)
        self.gain_label = QtWidgets.QLabel("Gain (x0.01 à x5.00) :")
        trans_layout.addWidget(self.gain_label)
        ...
        trans_layout.addWidget(self.gain_widget)
        self.unit_gain_label = QtWidgets.QLabel("Unité par carreau :")
        trans_layout.addWidget(self.unit_gain_label)
        ...
        trans_layout.addWidget(self.unit_gain_widget)
        self._update_gain_mode_ui("multiplier")
        trans_layout.addWidget(QtWidgets.QLabel("Offset vertical :"))
        ...
        trans_layout.addLayout(off_layout)
        ...
        trans_layout.addLayout(h_time)
        layout.addWidget(transform_group)

        bits_group = QtWidgets.QGroupBox("Bits")
        bits_layout = QtWidgets.QVBoxLayout(bits_group)
        bits_layout.addWidget(self.bits_checkbox)
        bits_layout.addWidget(self.bit_group_box)
        layout.addWidget(bits_group)

        misc_group = QtWidgets.QGroupBox("Divers")
        misc_layout = QtWidgets.QVBoxLayout(misc_group)
        misc_layout.addWidget(self.bring_to_front_button)
        misc_layout.addWidget(QtWidgets.QLabel("Affichage du nom de la courbe :"))
        misc_layout.addWidget(self.label_mode_combo)
